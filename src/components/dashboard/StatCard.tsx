          ...
          <div className="flex justify-between items-start">
            <div className="space-y-3">
              ...
              <div className="flex items-baseline gap-2">
                <h3 className="text-2xl font-bold tracking-tight text-glow">{value}</h3>
                {change && (
                  <div
                    className={cn(
            ...
            <div className="flex items-center justify-center h-12 w-12 rounded-xl bg-primary/20 text-primary purple-glow">
              {icon}
            </div>
          </div>
        </CardContent>
